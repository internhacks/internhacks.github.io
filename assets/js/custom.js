...
function initializeSchedule(){
	schedule = [
		...
		{time:"10-11", id:"w2", title:"Intro to HTML/CSS", companyName:"Google", img:"<img src='assets/img/htmlcss.png'>", instructor:"Manu Cornett", text:"This workshop will get you up to speed with the basics of HTML/CSS, to get you ready for a successful day of hacking!"},
...
function addTabSchedule(){
	$(".schedule").append('<div class="card z-depth-4 col s12 schedule-tabs hide-on-med-and-down"><h2>{ Schedule }</h2><ul class="tabs"></ul></div>');
